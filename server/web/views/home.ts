...
export const homeView = (meta: Meta, articles: Article[]) => {
    ...
    return `<!doctype html>
        ...
        <head>
            ...
            <title>${meta.siteConfigurations.siteTitle}</title>
            <meta property="og:title" content="${meta.siteConfigurations.siteTitle}">
            <meta property="og:site_name" content="${meta.siteConfigurations.siteName}">
            <meta property="og:type" content="website">
            <meta property="og:url" content="${meta.siteConfigurations.domainName}">
            <meta property="og:description" content="${meta.siteConfigurations.siteDescription}">
            <meta property="og:image" content="${meta.siteConfigurations.domainName + '/public/assets/images/og.jpg'}" />
    
            <meta name="description" content="${meta.siteConfigurations.siteDescription}">
            ...
            <link rel="canonical" href="${meta.siteConfigurations.domainName}" />
            ...
            <script type="application/ld+json">
                {
                    ...
                    "url": "${meta.siteConfigurations.domainName}",
        ...
        <body>
            ...
            <div class="main-container">
                <div class="container">
                    <h1 style="text-align: center;">${meta.siteConfigurations.siteTitle}</h1>
                    <br>
                    <p class="page-description">${meta.siteConfigurations.siteDescription}</p>
                    <br>
